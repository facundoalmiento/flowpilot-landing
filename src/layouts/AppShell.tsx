...
const navLinkClass =
  "group relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-morga-muted transition hover:bg-morga-surfaceAlt hover:text-morga-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-morga-accent";
        ...
        <aside className="hidden w-[300px] shrink-0 border-r border-morga-line/80 bg-morga-surface px-5 py-8 lg:sticky lg:top-0 lg:flex lg:h-screen lg:flex-col">
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `${navLinkClass} ${
                      isActive
                        ? "bg-morga-accentSoft text-morga-text before:absolute before:bottom-2 before:left-1.5 before:top-2 before:w-0.5 before:rounded-full before:bg-morga-accent"
                        : item.upcoming
                          ? "text-morga-muted/80"
                          : ""
                    }`
          ...
          <div className="shrink-0 space-y-3 pt-4">
            <button
              type="button"
              onClick={toggleTheme}
              className="flex w-full items-center justify-between gap-2 rounded-xl border border-morga-line/80 bg-morga-surfaceAlt/40 px-3 py-2.5 text-xs font-semibold text-morga-muted transition hover:bg-morga-surfaceAlt hover:text-morga-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-morga-accent"
            ...
            >
              ...
              <span className="text-[11px] font-normal normal-case text-morga-muted/80">Cambiar</span>
            </button>
            {user ? (
              <div className="flex items-center justify-between gap-2 rounded-xl border border-morga-line/80 bg-morga-surfaceAlt/40 px-3 py-2.5">
                ...
                <button
                  ...
                  className="flex shrink-0 items-center gap-1 rounded-lg px-2 py-1 text-xs font-semibold text-morga-muted transition hover:bg-morga-surface hover:text-morga-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-morga-accent"
